...
export const ProfileA = ({route, navigation}) => {
    const Cin = route.params.Cin;
    const[NomAgent , setNomAgent] = useState();
    const[AdresseAgent , setAdresseAgent] = useState();
    const[Numero, setNumero] = useState();
    const handleProfile = async() => {
        try{
            const response = await fetch('http://192.168.1.4:3000/agent/profile', {
                method: 'POST',
                headers: {
            ...
            if(response.status == 201){
                ...
                setAdresseAgent(res.AdresseAgent);
        ...
        <View style= {styles.mainView} >
             ...
             <View style= {styles.navContainer}>
                ...
                <View style= {styles.profileView}>
                    ...
                    <Text style= {styles.username}>{NomAgent}</Text>
                </View>
             </LinearGradient>
             ...
             <View style= {styles.infoView}>
                <View style= {styles.input}>
                    ...
                    <View style= {styles.rowInput}>
                        <Text style= {styles.textInput}>{Cin}</Text>
                    </View>
                </View>
                ...
                <View style= {styles.input}>
                    ...
                    <View style= {styles.rowInput}>
                        <Text style= {styles.textInput}>{AdresseAgent}</Text>
                    </View>
                </View>
                <View style= {styles.br}></View> 
